...
namespace PRJCLUMS
{
    public class CreateDailyReport
    {
        ...
        void CreateDocument()
        {
            ...
            this.document.Info.Subject = "Daily Reports";
        ...
        void CreatePage()
        {
            ...
            paragraph.AddFormattedText("DAILY REPORT", TextFormat.Bold);
            paragraph.AddTab();
        ...
        void FillContent()
        {
            ...
            foreach (ListViewItem listItems in listViewItem)
            {
                ...
                row1.TopPadding = 1.5;
                row1.Cells[0].AddParagraph(listItems.SubItems[0].Text); // invoice no
                row1.Cells[1].AddParagraph(listItems.SubItems[3].Text); // item name
                row1.Cells[2].AddParagraph(listItems.SubItems[9].Text); // customer
                row1.Cells[3].AddParagraph(listItems.SubItems[6].Text); // price
                row1.Cells[4].AddParagraph(listItems.SubItems[7].Text); // quantity
                row1.Cells[5].AddParagraph(listItems.SubItems[8].Text); // total price
            }
