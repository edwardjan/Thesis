...
namespace PRJCLUMS
{
    public class CreateItemReport
    {
        ...
        void CreateDocument()
        {
            ...
            this.document.Info.Subject = "Item Reports History";
        ...
        void CreatePage()
        {
            ...
            paragraph.AddFormattedText("ITEM REPORT HISTORY", TextFormat.Bold);
            paragraph.AddTab();
            ...
            row.Cells[0].AddParagraph("Item No.");
            ...
            row.Cells[4].AddParagraph("Stock");
            row.Cells[4].Format.Alignment = ParagraphAlignment.Left;
            row.Cells[4].VerticalAlignment = VerticalAlignment.Bottom;

            row.Cells[5].AddParagraph("Item Sold");
        ...
        void FillContent()
        {
            ...
            foreach (ListViewItem listItems in listViewItem)
            {
                ...
                row1.TopPadding = 1.5;
                row1.Cells[0].AddParagraph(listItems.SubItems[0].Text); // item no
                row1.Cells[1].AddParagraph(listItems.SubItems[1].Text); // item name
                row1.Cells[2].AddParagraph(listItems.SubItems[3].Text); // description
                row1.Cells[3].AddParagraph(listItems.SubItems[4].Text); // price
                row1.Cells[4].AddParagraph(listItems.SubItems[5].Text); // stock
                row1.Cells[5].AddParagraph(listItems.SubItems[6].Text); // item sold
            }
