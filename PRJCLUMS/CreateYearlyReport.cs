...
namespace PRJCLUMS
{
    public class CreateYearlyReport
    {
        ...
        void CreateDocument()
        {
            ...
            this.document.Info.Subject = "Yearly Reports";
        ...
        void CreatePage()
        {
            ...
            paragraph.AddFormattedText("YEARLY REPORT", TextFormat.Bold);
            paragraph.AddTab();
            ...
            row.Cells[1].AddParagraph("Item Sold");
            row.Cells[1].Format.Alignment = ParagraphAlignment.Left;
            row.Cells[1].VerticalAlignment = VerticalAlignment.Bottom;

            row.Cells[2].AddParagraph("Total Amount Due");
        ...
        void FillContent()
        {
            ...
            foreach (ListViewItem listItems in listViewItem)
            {
                ...
                row1.TopPadding = 1.5;
                row1.Cells[0].AddParagraph(listItems.SubItems[0].Text); // Month
                row1.Cells[1].AddParagraph(listItems.SubItems[1].Text); // Item Sold
                row1.Cells[2].AddParagraph(listItems.SubItems[2].Text); // Total Amount Due
            }
